...
// TMDB configuration
const tmdbApiKey = window.tmdbApiKey || '5c66fecac3410a4da2709f1d944be38c'; // Usar variável de ambiente ou chave de fallback
const tmdbImageBaseUrl = window.tmdbImageBaseUrl || 'https://image.tmdb.org/t/p/w500';
